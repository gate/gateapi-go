...
/*
P2pMerchantQuerySpotBalance Query spot balance
...
*/
func (a *P2pApiService) P2pMerchantQuerySpotBalance(ctx context.Context) (*http.Response, error) {
	var (
...
/*
P2pMerchantAccountSetMerchantWorkHours Set merchant working status and custom working hours
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param setMerchantWorkHoursRequest

@return P2pMerchantWorkHoursResponse
*/
func (a *P2pApiService) P2pMerchantAccountSetMerchantWorkHours(ctx context.Context, setMerchantWorkHoursRequest SetMerchantWorkHoursRequest) (P2pMerchantWorkHoursResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  P2pMerchantWorkHoursResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/p2p/merchant/account/set_merchant_work_hours"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	...
	// body params
	localVarPostBody = &setMerchantWorkHoursRequest
	if ctx == nil {
		ctx = context.Background()
	}
	if ctx.Value(ContextGateAPIV4) == nil {

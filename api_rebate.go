...
/*
AgencyTransactionHistory Broker obtains transaction history of recommended users
...
/*
AgencyCommissionsHistory Broker obtains rebate history of recommended users
Record query time range cannot exceed 30 days
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
/*
PartnerTransactionHistory Partner obtains transaction history of recommended users
Record query time range cannot exceed 30 days
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
/*
PartnerCommissionsHistory Partner obtains rebate records of recommended users
Record query time range cannot exceed 30 days
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
/*
RebateBrokerCommissionHistory Broker obtains user's rebate records
Record query time range cannot exceed 30 days
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  ...
  - @param "Offset" (optional.Int32) -  List offset, starting from 0
  - @param "UserId" (optional.Int64) -  User ID. If not specified, all user records will be returned
  - @param "From" (optional.Int64) -  Start time of the query record. If not specified, defaults to 30 days before the current time
  - @param "To" (optional.Int64) -  End timestamp for the query, defaults to current time if not specified
...
/*
RebateBrokerTransactionHistory Broker obtains user's trading history
Record query time range cannot exceed 30 days
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
@return []BrokerTransactionHistory
*/
func (a *RebateApiService) RebateBrokerTransactionHistory(ctx context.Context, localVarOptionals *RebateBrokerTransactionHistoryOpts) ([]BrokerTransactionHistory, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  []BrokerTransactionHistory
	)
...
/*
RebateUserInfo User obtains rebate information
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
/*
GetPartnerApplicationRecent Get recent partner application records
...
*/
func (a *RebateApiService) GetPartnerApplicationRecent(ctx context.Context) (PartnerApplicationResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  PartnerApplicationResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/rebate/partner/applications/recent"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
...
/*
GetPartnerEligibility Check partner application eligibility
...
*/
func (a *RebateApiService) GetPartnerEligibility(ctx context.Context) (EligibilityResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  EligibilityResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/rebate/partner/eligibility"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
...
// GetPartnerAgentDataAggregatedOpts Optional parameters for the method 'GetPartnerAgentDataAggregated'
type GetPartnerAgentDataAggregatedOpts struct {
	StartDate    optional.String
	EndDate      optional.String
	BusinessType optional.Int32
}

/*
GetPartnerAgentDataAggregated Aggregated partner agent statistics
Query aggregated partner-agent statistics for a time range, including rebate amount, trading volume, net fee, customer count, and trading user count. **Notes:** - &#x60;trading_user_count&#x60; is only returned when &#x60;business_type&#x3D;0&#x60; (All). - Time parameters use UTC+8. - If no time range is passed, the last 7 days are queried by default. - Partner agents only; sub-accounts are not allowed.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param optional nil or *GetPartnerAgentDataAggregatedOpts - Optional Parameters:
  - @param "StartDate" (optional.String) -  Query start time, format: yyyy-mm-dd hh:ii:ss (UTC+8). If omitted, defaults to the start of the last 7 days.
  - @param "EndDate" (optional.String) -  Query end time, format: yyyy-mm-dd hh:ii:ss (UTC+8). If omitted, defaults to the end of the last 7 days.
  - @param "BusinessType" (optional.Int32) -  Business type filter: - 0: All (default) - 1: Spot - 2: Futures - 3: Alpha - 4: Web3 - 5: Perps (DEX) - 6: Exchange All - 7: Web3 All - 8: TradFi

@return PartnerDataAggregatedResponse
*/
func (a *RebateApiService) GetPartnerAgentDataAggregated(ctx context.Context, localVarOptionals *GetPartnerAgentDataAggregatedOpts) (PartnerDataAggregatedResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  PartnerDataAggregatedResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/rebate/partner/data/aggregated"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}

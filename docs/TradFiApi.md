...
func main() {
    ...
    result, _, err := client.TradFiApi.QueryMt5AccountInfo(ctx)
    if err != nil {
...
func main() {
    ...
    result, _, err := client.TradFiApi.QueryCategories(ctx)
    if err != nil {
        if e, ok := err.(gateapi.GateAPIError); ok {
            fmt.Printf("gate api error: %s\n", e.Error())
        } else {
...
func main() {
    ...
    result, _, err := client.TradFiApi.QuerySymbols(ctx)
    if err != nil {
        if e, ok := err.(gateapi.GateAPIError); ok {
            fmt.Printf("gate api error: %s\n", e.Error())
        } else {
...
func main() {
    ...
    result, _, err := client.TradFiApi.QuerySymbolKline(ctx, symbol, klineType, nil)
    if err != nil {
        if e, ok := err.(gateapi.GateAPIError); ok {
            fmt.Printf("gate api error: %s\n", e.Error())
        } else {
...
func main() {
    ...
    result, _, err := client.TradFiApi.QuerySymbolTicker(ctx, symbol)
    if err != nil {
        if e, ok := err.(gateapi.GateAPIError); ok {
            fmt.Printf("gate api error: %s\n", e.Error())
        } else {
...
func main() {
    ...
    result, _, err := client.TradFiApi.CreateTradFiUser(ctx)
    if err != nil {
        if e, ok := err.(gateapi.GateAPIError); ok {
            fmt.Printf("gate api error: %s\n", e.Error())
        } else {
...
func main() {
    ...
    result, _, err := client.TradFiApi.QueryUserAssets(ctx)
    if err != nil {
        if e, ok := err.(gateapi.GateAPIError); ok {
            fmt.Printf("gate api error: %s\n", e.Error())
        } else {
...
func main() {
    ...
    result, _, err := client.TradFiApi.QueryTransaction(ctx, nil)
    if err != nil {
        if e, ok := err.(gateapi.GateAPIError); ok {
            fmt.Printf("gate api error: %s\n", e.Error())
        } else {
...
func main() {
    ...
    result, _, err := client.TradFiApi.QueryOrderList(ctx)
    if err != nil {
        if e, ok := err.(gateapi.GateAPIError); ok {
            fmt.Printf("gate api error: %s\n", e.Error())
        } else {
...
func main() {
    ...
    result, _, err := client.TradFiApi.DeleteOrder(ctx, orderId)
    if err != nil {
        if e, ok := err.(gateapi.GateAPIError); ok {
            fmt.Printf("gate api error: %s\n", e.Error())
        } else {
...
**side** | **optional.Int32**| Order side (1&#x3D;sell, 2&#x3D;buy) | 
...
func main() {
    ...
    result, _, err := client.TradFiApi.QueryOrderHistoryList(ctx, nil)
    if err != nil {
        if e, ok := err.(gateapi.GateAPIError); ok {
            fmt.Printf("gate api error: %s\n", e.Error())
        } else {
...
func main() {
    ...
    result, _, err := client.TradFiApi.QueryPositionList(ctx)
    if err != nil {
        if e, ok := err.(gateapi.GateAPIError); ok {
            fmt.Printf("gate api error: %s\n", e.Error())
        } else {
...
func main() {
    ...
    result, _, err := client.TradFiApi.QueryPositionHistoryList(ctx, nil)
    if err != nil {
        if e, ok := err.(gateapi.GateAPIError); ok {
            fmt.Printf("gate api error: %s\n", e.Error())
        } else {

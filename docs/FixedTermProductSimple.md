...
**SimpleEarn** | **int32** | Whether fixed-to-flexible conversion is supported: 0 for not supported, 1 for supported | [optional] 
**MinVip** | **int32** | Minimum VIP level requirement, 0 means no restriction | [optional] 
**MaxVip** | **int32** | Maximum VIP level requirement, 0 means no restriction | [optional] 

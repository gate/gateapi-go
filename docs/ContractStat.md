...
**LsrTaker** | **float32** | Long/short taker ratio | [optional] 
**LsrAccount** | **float32** | Long/short position user ratio | [optional] 
**LongLiqSize** | **int64** | Long liquidation size (contracts) | [optional] 
...
**ShortLiqSize** | **int64** | Short liquidation size (contracts) | [optional] 
...
**OpenInterest** | **int64** | Total open interest size (contracts) | [optional] 

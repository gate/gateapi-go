...
**AdvertisersLimit** | **int32** | Whether merchant trading restriction is allowed | [optional] 
...
**CompletedRateLimit** | **int32** | 30-day completion rate limit | [optional] 
...
**NewHand** | **int32** | Special ad type | [optional] 
...
**IsOutTime** | **int32** | Whether ad is currently expired | [optional] 
**RateRefId** | **int32** | Floating price reference configuration | [optional] 
**RateOffset** | **string** | Floating ratio | [optional] 
**RateFixed** | **int32** | Reference price type: 0&#x3D;Floating, 1&#x3D;Fixed | [optional] 
**FloatTrend** | **int32** | Floating order direction | [optional] 
**InDispute** | **int32** | Whether ad has disputed transactions | [optional] 
**AutoReply** | **string** | Auto reply data | [optional] 
**Timestamp** | **int32** | Ad creation time | [optional] 
**IsHedge** | **int32** | Auto delegation | [optional] 

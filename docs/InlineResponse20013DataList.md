...
**TopId** | **int32** | Pin ID, 0 means not pinned | 
**ParentId** | **int32** | Parent activity ID, 0 means no parent activity | 
**NewImg** | **string** | New activity image URL (light mode) | 
**NewImgDark** | **string** | New activity image URL (dark mode) | 
**Tag** | **[]string** | Activity tag list | 

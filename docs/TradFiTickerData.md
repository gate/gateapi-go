...
**CloseTime** | **int64** | Close time (Unix timestamp in seconds) | [optional] 
**OpenTime** | **int64** | Open time (Unix timestamp in seconds) | [optional] 
**NextOpenTime** | **int64** | Next open time (0 means none) | [optional] 

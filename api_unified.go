...
/*
SetUserLeverage Set leverage for all of the user's borrowed currencies
Note the following: - Leverage cannot be changed for currencies with outstanding loans. - A leverage value above a currency&#39;s limit is capped at that limit. - Failures are not rolled back and affect only the currencies that failed. For example, if USDT has an outstanding loan, only the USDT leverage remains unchanged.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param userLeverageSetting

@return []LeverageFailedCurrencies
*/
func (a *UnifiedApiService) SetUserLeverage(ctx context.Context, userLeverageSetting UserLeverageSetting) ([]LeverageFailedCurrencies, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  []LeverageFailedCurrencies
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/unified/leverage/user_setting"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	...
	// body params
	localVarPostBody = &userLeverageSetting
	if ctx == nil {
		ctx = context.Background()
	}
	if ctx.Value(ContextGateAPIV4) == nil {
...
/*
GetEstimatedQuickRepayment Estimated quick repayment details
Available for unified account cross-currency margin mode and portfolio margin mode
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return QuickEstimatedRepayment
*/
func (a *UnifiedApiService) GetEstimatedQuickRepayment(ctx context.Context) (QuickEstimatedRepayment, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  QuickEstimatedRepayment
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/unified/estimated_quick_repayment"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
...
/*
CreateQuickRepayment Quick repayment
...
*/
func (a *UnifiedApiService) CreateQuickRepayment(ctx context.Context, quickRepaymentRequest QuickRepaymentRequest) (QuickRepaymentResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  QuickRepaymentResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/unified/quick_repayment"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	...
	// body params
	localVarPostBody = &quickRepaymentRequest
	if ctx == nil {
		ctx = context.Background()
	}
	if ctx.Value(ContextGateAPIV4) == nil {
...
/*
GetUnifiedDeltaNeutral Query the account Delta-neutral strategy mode setting
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return DeltaNeutralEnabled
*/
func (a *UnifiedApiService) GetUnifiedDeltaNeutral(ctx context.Context) (DeltaNeutralEnabled, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  DeltaNeutralEnabled
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/unified/delta_neutral"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
...
/*
SetUnifiedDeltaNeutral Set the account Delta-neutral strategy mode
...
@return DeltaNeutralEnabled
*/
func (a *UnifiedApiService) SetUnifiedDeltaNeutral(ctx context.Context, deltaNeutralEnabled DeltaNeutralEnabled) (DeltaNeutralEnabled, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// body params
	localVarPostBody = &deltaNeutralEnabled
	if ctx == nil {
		ctx = context.Background()
	}
	if ctx.Value(ContextGateAPIV4) == nil {

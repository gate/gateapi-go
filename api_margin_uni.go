...
/*
GetUniCurrencyPair Get lending market details
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
/*
GetMarginUniEstimateRate Estimate interest rate for isolated margin currencies
...
/*
ListUniLoanRecords Query loan records
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
/*
ListUniLoanInterestRecords Query interest deduction records
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
/*
GetUniBorrowable Query maximum borrowable amount by currency
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

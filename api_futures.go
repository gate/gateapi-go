...
// ListFuturesContractsAllOpts Optional parameters for the method 'ListFuturesContractsAll'
type ListFuturesContractsAllOpts struct {
	Limit  optional.Int32
	Offset optional.Int32
}
...
@return []Contract
*/
func (a *FuturesApiService) ListFuturesContractsAll(ctx context.Context, settle string, localVarOptionals *ListFuturesContractsAllOpts) ([]Contract, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/futures/{settle}/contracts_all"
	localVarPath = strings.Replace(localVarPath, "{"+"settle"+"}", url.QueryEscape(parameterToString(settle, "")), -1)
...
*/
func (a *FuturesApiService) ListBatchFuturesFundingRates(ctx context.Context, settle string, batchFundingRatesRequest BatchFundingRatesRequest) ([]BatchFundingRatesResponse, *http.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  []BatchFundingRatesResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/futures/{settle}/funding_rates"
	localVarPath = strings.Replace(localVarPath, "{"+"settle"+"}", url.QueryEscape(parameterToString(settle, "")), -1)
	...
	// body params
	localVarPostBody = &batchFundingRatesRequest
	if ctx == nil {
		ctx = context.Background()
	}
	ctx = context.WithValue(ctx, ContextPublic, true)
...
// ListPositionsTimerangeOpts Optional parameters for the method 'ListPositionsTimerange'
type ListPositionsTimerangeOpts struct {
	From   optional.Int64
	To     optional.Int64
	Limit  optional.Int32
	Offset optional.Int32
...
@return []PositionTimerange
*/
func (a *FuturesApiService) ListPositionsTimerange(ctx context.Context, settle string, contract string, localVarOptionals *ListPositionsTimerangeOpts) ([]PositionTimerange, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  []PositionTimerange
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/futures/{settle}/positions_timerange"
	localVarPath = strings.Replace(localVarPath, "{"+"settle"+"}", url.QueryEscape(parameterToString(settle, "")), -1)
...
func (a *FuturesApiService) UpdateDualCompPositionCrossMode(ctx context.Context, settle string, updateDualCompPositionCrossModeRequest UpdateDualCompPositionCrossModeRequest) ([]Position, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/futures/{settle}/dual_comp/positions/cross_mode"
	localVarPath = strings.Replace(localVarPath, "{"+"settle"+"}", url.QueryEscape(parameterToString(settle, "")), -1)
...
ListAutoDeleverages Query ADL auto-deleveraging order information
  ...
  - @param "From" (optional.Int64) -  Start timestamp  Specify start time, time format is Unix timestamp. If not specified, it defaults to (the data start time of the time range actually returned by to and limit)
  - @param "To" (optional.Int64) -  Termination Timestamp  Specify the end time. If not specified, it defaults to the current time, and the time format is a Unix timestamp
  - @param "At" (optional.Int32) -  Specify auto-deleveraging timestamp
...
// CreateFuturesBBOOrderOpts Optional parameters for the method 'CreateFuturesBBOOrder'
type CreateFuturesBBOOrderOpts struct {
	XGateExptime optional.String
}
...
@return FuturesOrder
*/
func (a *FuturesApiService) CreateFuturesBBOOrder(ctx context.Context, settle string, futuresBboOrder FuturesBboOrder, localVarOptionals *CreateFuturesBBOOrderOpts) (FuturesOrder, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/futures/{settle}/bbo_orders"
	localVarPath = strings.Replace(localVarPath, "{"+"settle"+"}", url.QueryEscape(parameterToString(settle, "")), -1)
	...
	// body params
	localVarPostBody = &futuresBboOrder
	if ctx == nil {
		ctx = context.Background()
	}
	if ctx.Value(ContextGateAPIV4) == nil {
...
func (a *FuturesApiService) CreateTrailOrder(ctx context.Context, settle string, createTrailOrder CreateTrailOrder) (CreateTrailOrderResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/futures/{settle}/autoorder/v1/trail/create"
	localVarPath = strings.Replace(localVarPath, "{"+"settle"+"}", url.QueryEscape(parameterToString(settle, "")), -1)
	...
	// body params
	localVarPostBody = &createTrailOrder
	if ctx == nil {
		ctx = context.Background()
	}
	if ctx.Value(ContextGateAPIV4) == nil {
...
func (a *FuturesApiService) StopTrailOrder(ctx context.Context, settle string, stopTrailOrder StopTrailOrder) (TrailOrderResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/futures/{settle}/autoorder/v1/trail/stop"
	localVarPath = strings.Replace(localVarPath, "{"+"settle"+"}", url.QueryEscape(parameterToString(settle, "")), -1)
	...
	// body params
	localVarPostBody = &stopTrailOrder
	if ctx == nil {
		ctx = context.Background()
	}
	if ctx.Value(ContextGateAPIV4) == nil {
...
func (a *FuturesApiService) StopAllTrailOrders(ctx context.Context, settle string, stopAllTrailOrders StopAllTrailOrders) (TrailOrderListResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/futures/{settle}/autoorder/v1/trail/stop_all"
	localVarPath = strings.Replace(localVarPath, "{"+"settle"+"}", url.QueryEscape(parameterToString(settle, "")), -1)
	...
	// body params
	localVarPostBody = &stopAllTrailOrders
	if ctx == nil {
		ctx = context.Background()
	}
	if ctx.Value(ContextGateAPIV4) == nil {
...
// GetTrailOrdersOpts Optional parameters for the method 'GetTrailOrders'
type GetTrailOrdersOpts struct {
	Contract        optional.String
	...
	HideCancel      optional.Bool
	RelatedPosition optional.Int32
	SortByTrigger   optional.Bool
	ReduceOnly      optional.Int32
	Side            optional.Int32
}
...
GetTrailOrders Get trail order list
  ...
  - @param "StartAt" (optional.Int64) -  Start time of time range
  - @param "EndAt" (optional.Int64) -  End time of time range
  - @param "PageNum" (optional.Int32) -  Page number, starting from 1
  - @param "PageSize" (optional.Int32) -  Number of items per page
  - @param "SortBy" (optional.Int32) -  Common sort field, 1-creation time, 2-end time
  - @param "HideCancel" (optional.Bool) -  Hide cancelled orders
  - @param "RelatedPosition" (optional.Int32) -  Associated position, if provided, only return orders associated with this position, 1-long, 2-short
  - @param "SortByTrigger" (optional.Bool) -  Sort by trigger price and activation price, easy to trigger or activate first, only for current orders associated with positions
...
func (a *FuturesApiService) GetTrailOrders(ctx context.Context, settle string, localVarOptionals *GetTrailOrdersOpts) (TrailOrderListResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/futures/{settle}/autoorder/v1/trail/list"
	localVarPath = strings.Replace(localVarPath, "{"+"settle"+"}", url.QueryEscape(parameterToString(settle, "")), -1)
	...
	if localVarOptionals != nil && localVarOptionals.PageNum.IsSet() {
		localVarQueryParams.Add("page_num", parameterToString(localVarOptionals.PageNum.Value(), ""))
	}
	...
	if localVarOptionals != nil && localVarOptionals.HideCancel.IsSet() {
		localVarQueryParams.Add("hide_cancel", parameterToString(localVarOptionals.HideCancel.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.RelatedPosition.IsSet() {
		localVarQueryParams.Add("related_position", parameterToString(localVarOptionals.RelatedPosition.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.SortByTrigger.IsSet() {
		localVarQueryParams.Add("sort_by_trigger", parameterToString(localVarOptionals.SortByTrigger.Value(), ""))
	}
...
func (a *FuturesApiService) GetTrailOrderDetail(ctx context.Context, settle string, id int64) (TrailOrderDetailResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/futures/{settle}/autoorder/v1/trail/detail"
	localVarPath = strings.Replace(localVarPath, "{"+"settle"+"}", url.QueryEscape(parameterToString(settle, "")), -1)
...
func (a *FuturesApiService) UpdateTrailOrder(ctx context.Context, settle string, updateTrailOrder UpdateTrailOrder) (TrailOrderResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/futures/{settle}/autoorder/v1/trail/update"
	localVarPath = strings.Replace(localVarPath, "{"+"settle"+"}", url.QueryEscape(parameterToString(settle, "")), -1)
	...
	// body params
	localVarPostBody = &updateTrailOrder
	if ctx == nil {
		ctx = context.Background()
	}
	if ctx.Value(ContextGateAPIV4) == nil {
...
// GetTrailOrderChangeLogOpts Optional parameters for the method 'GetTrailOrderChangeLog'
type GetTrailOrderChangeLogOpts struct {
	PageNum  optional.Int32
	PageSize optional.Int32
}
...
func (a *FuturesApiService) GetTrailOrderChangeLog(ctx context.Context, settle string, id int64, localVarOptionals *GetTrailOrderChangeLogOpts) (TrailOrderChangeLogResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/futures/{settle}/autoorder/v1/trail/change_log"
	localVarPath = strings.Replace(localVarPath, "{"+"settle"+"}", url.QueryEscape(parameterToString(settle, "")), -1)
...
*/
func (a *FuturesApiService) CreateChaseOrder(ctx context.Context, settle string, createChaseOrderReq CreateChaseOrderReq) (CreateChaseOrderResp, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  CreateChaseOrderResp
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/futures/{settle}/autoorder/v1/chase/create"
	localVarPath = strings.Replace(localVarPath, "{"+"settle"+"}", url.QueryEscape(parameterToString(settle, "")), -1)
	...
	// body params
	localVarPostBody = &createChaseOrderReq
	if ctx == nil {
		ctx = context.Background()
	}
	if ctx.Value(ContextGateAPIV4) == nil {
...
*/
func (a *FuturesApiService) StopChaseOrder(ctx context.Context, settle string, stopChaseOrderReq StopChaseOrderReq) (StopChaseOrderResp, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  StopChaseOrderResp
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/futures/{settle}/autoorder/v1/chase/stop"
	localVarPath = strings.Replace(localVarPath, "{"+"settle"+"}", url.QueryEscape(parameterToString(settle, "")), -1)
	...
	// body params
	localVarPostBody = &stopChaseOrderReq
	if ctx == nil {
		ctx = context.Background()
	}
	if ctx.Value(ContextGateAPIV4) == nil {
...
*/
func (a *FuturesApiService) StopAllChaseOrders(ctx context.Context, settle string, stopAllChaseOrdersReq StopAllChaseOrdersReq) (StopAllChaseOrdersResp, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  StopAllChaseOrdersResp
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/futures/{settle}/autoorder/v1/chase/stop_all"
	localVarPath = strings.Replace(localVarPath, "{"+"settle"+"}", url.QueryEscape(parameterToString(settle, "")), -1)
	...
	// body params
	localVarPostBody = &stopAllChaseOrdersReq
	if ctx == nil {
		ctx = context.Background()
	}
	if ctx.Value(ContextGateAPIV4) == nil {
...
// GetChaseOrdersOpts Optional parameters for the method 'GetChaseOrders'
type GetChaseOrdersOpts struct {
	Contract   optional.String
	IsFinished optional.Bool
	StartAt    optional.Int64
	EndAt      optional.Int64
...
GetChaseOrders List chase orders
  ...
  - @param "IsFinished" (optional.Bool) -  true to query finished orders, false to query in-progress orders
  - @param "StartAt" (optional.Int64) -  Lower time bound for the history list, paired with end_at. Required when is_finished is true
  - @param "EndAt" (optional.Int64) -  Upper time bound for the history list, paired with start_at. Required when is_finished is true
  - @param "PageNum" (optional.Int32) -  Page number, starting from 1
  - @param "PageSize" (optional.Int32) -  Page size; must be between 1 and 100
  - @param "HideCancel" (optional.Bool) -  When true, cancelled orders are hidden in the list
  - @param "ReduceOnly" (optional.Int32) -  OptionalBool: 0 unknown, 1 true, 2 false; used to filter by reduce-only flag
  - @param "Side" (optional.Int32) -  Filter by long/short side: 1 long, 2 short

@return GetChaseOrdersResp
*/
func (a *FuturesApiService) GetChaseOrders(ctx context.Context, settle string, sortBy int32, localVarOptionals *GetChaseOrdersOpts) (GetChaseOrdersResp, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  GetChaseOrdersResp
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/futures/{settle}/autoorder/v1/chase/list"
	localVarPath = strings.Replace(localVarPath, "{"+"settle"+"}", url.QueryEscape(parameterToString(settle, "")), -1)
	...
	localVarQueryParams.Add("sort_by", parameterToString(sortBy, ""))
	if localVarOptionals != nil && localVarOptionals.HideCancel.IsSet() {
		localVarQueryParams.Add("hide_cancel", parameterToString(localVarOptionals.HideCancel.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.ReduceOnly.IsSet() {
...
*/
func (a *FuturesApiService) GetChaseOrderDetail(ctx context.Context, settle string, id string) (GetChaseOrderDetailResp, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  GetChaseOrderDetailResp
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/futures/{settle}/autoorder/v1/chase/detail"
	localVarPath = strings.Replace(localVarPath, "{"+"settle"+"}", url.QueryEscape(parameterToString(settle, "")), -1)
...
@return TriggerOrderResponse
*/
func (a *FuturesApiService) UpdatePriceTriggeredOrder(ctx context.Context, settle string, futuresUpdatePriceTriggeredOrder FuturesUpdatePriceTriggeredOrder) (TriggerOrderResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/futures/{settle}/price_orders/amend"
	localVarPath = strings.Replace(localVarPath, "{"+"settle"+"}", url.QueryEscape(parameterToString(settle, "")), -1)
	...
	// body params
	localVarPostBody = &futuresUpdatePriceTriggeredOrder
	if ctx == nil {
		ctx = context.Background()
	}
	if ctx.Value(ContextGateAPIV4) == nil {

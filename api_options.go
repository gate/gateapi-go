...
/*
ListOptionsUnderlyings List all underlying assets
...
/*
ListOptionsExpirations List all expiration dates
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
/*
ListOptionsContracts List all contracts for specified underlying and expiration date
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param underlying Underlying (Obtained by listing underlying endpoint)
  - @param optional nil or *ListOptionsContractsOpts - Optional Parameters:
  - @param "Expiration" (optional.Int64) -  Unix timestamp of expiration date
...
/*
GetOptionsContract Query specified contract details
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param contract
...
/*
GetOptionsSettlement Get specified contract settlement information
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param contract
  - @param underlying Underlying (Obtained by listing underlying endpoint)
  - @param at
...
/*
ListMyOptionsSettlements Query personal settlement records
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param underlying Underlying (Obtained by listing underlying endpoint)
...
/*
ListOptionsOrderBook Query options contract order book
...
/*
ListOptionsTickers Query options market ticker information
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param underlying Underlying (Obtained by listing underlying endpoint)
...
/*
ListOptionsUnderlyingTickers Query underlying ticker information
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
/*
ListOptionsCandlesticks Options contract market candlestick chart
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param contract Options contract name
...
/*
ListOptionsUnderlyingCandlesticks Underlying index price candlestick chart
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param underlying Underlying (Obtained by listing underlying endpoint)
...
/*
ListOptionsTrades Market trade records
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param optional nil or *ListOptionsTradesOpts - Optional Parameters:
  - @param "Contract" (optional.String) -  Options contract name
  - @param "Type_" (optional.String) -  `C` for call, `P` for put
  - @param "Limit" (optional.Int32) -  Maximum number of records returned in a single list
  - @param "Offset" (optional.Int32) -  List offset, starting from 0
  - @param "From" (optional.Int64) -  Start timestamp  Specify start time, time format is Unix timestamp. If not specified, it defaults to (the data start time of the time range actually returned by to and limit)
  - @param "To" (optional.Int64) -  Termination Timestamp  Specify the end time. If not specified, it defaults to the current time, and the time format is a Unix timestamp
...
/*
ListOptionsAccountBook Query account change history
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  ...
  - @param "From" (optional.Int64) -  Start timestamp  Specify start time, time format is Unix timestamp. If not specified, it defaults to (the data start time of the time range actually returned by to and limit)
  - @param "To" (optional.Int64) -  Termination Timestamp  Specify the end time. If not specified, it defaults to the current time, and the time format is a Unix timestamp
  - @param "Type_" (optional.String) -  Change types: - dnw: Deposit & Withdrawal - prem: Trading premium - fee: Trading fee - refr: Referrer rebate - set: Settlement P&L
...
/*
CancelOptionsOrders Cancel all orders with 'open' status
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
/*
GetOptionsOrder Query single order details
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
/*
AmendOptionsOrder Option Order Modification
...
@return OptionsOrder
*/
func (a *OptionsApiService) AmendOptionsOrder(ctx context.Context, orderId int64, amendOptionsOrderRequest AmendOptionsOrderRequest) (OptionsOrder, *http.Response, error) {
	var (
	...
	// body params
	localVarPostBody = &amendOptionsOrderRequest
	if ctx == nil {
		ctx = context.Background()
	}
	if ctx.Value(ContextGateAPIV4) == nil {
...
/*
CancelOptionsOrder Cancel single order
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param orderId Order ID returned when order is successfully created
...
@return TriggerTime
*/
func (a *OptionsApiService) CountdownCancelAllOptions(ctx context.Context, countdownCancelAllOptionsTask CountdownCancelAllOptionsTask) (TriggerTime, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/options/countdown_cancel_all"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	...
	// body params
	localVarPostBody = &countdownCancelAllOptionsTask
	if ctx == nil {
		ctx = context.Background()
	}
	if ctx.Value(ContextGateAPIV4) == nil {
...
/*
ListMyOptionsTrades Query personal trading records
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param underlying Underlying (Obtained by listing underlying endpoint)
...
// GetOptionsMMPOpts Optional parameters for the method 'GetOptionsMMP'
type GetOptionsMMPOpts struct {
	Underlying optional.String
}
...
@return []OptionsMmp
*/
func (a *OptionsApiService) GetOptionsMMP(ctx context.Context, localVarOptionals *GetOptionsMMPOpts) ([]OptionsMmp, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  []OptionsMmp
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/options/mmp"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
...
/*
SetOptionsMMP MMP Settings
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param optionsMmp

@return OptionsMmp
*/
func (a *OptionsApiService) SetOptionsMMP(ctx context.Context, optionsMmp OptionsMmp) (OptionsMmp, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
ResetOptionsMMP MMP Reset
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param optionsMmpReset

@return OptionsMmp
*/
func (a *OptionsApiService) ResetOptionsMMP(ctx context.Context, optionsMmpReset OptionsMmpReset) (OptionsMmp, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/options/mmp/reset"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	...
	// body params
	localVarPostBody = &optionsMmpReset
	if ctx == nil {
		ctx = context.Background()
	}
	if ctx.Value(ContextGateAPIV4) == nil {

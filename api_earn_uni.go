...
/*
ListUniCurrencies Query lending currency list
...
/*
GetUniCurrency Query single lending currency details
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
/*
ListUserUniLends Query user's lending order list
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
/*
CreateUniLend Create lending or redemption
...
/*
ChangeUniLend Amend user lending information
...
/*
ListUniLendRecords Query lending transaction records
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  ...
  - @param "Type_" (optional.String) -  Operation type: lend - Lend, redeem - Redeem
...
/*
GetUniInterest Query user's total interest income for specified currency
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param currency Currency
...
/*
ListUniInterestRecords Query user dividend records
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
@return []UniChartPoint
*/
func (a *EarnUniApiService) ListUniChart(ctx context.Context, from int64, to int64, asset string) ([]UniChartPoint, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  []UniChartPoint
	)
...
@return []UniEstimatedRate
*/
func (a *EarnUniApiService) ListUniRate(ctx context.Context) ([]UniEstimatedRate, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  []UniEstimatedRate
	)

...
type InlineResponse20010DataList struct {
	...
	FiatCurrencyInfo InlineResponse20010DataFiatCurrencyInfo `json:"fiat_currency_info,omitempty"`
	// Fiat amount
	FiatAmount string `json:"fiat_amount,omitempty"`
	// Stablecoin
	CryptoCurrency     string                                    `json:"crypto_currency,omitempty"`
	CryptoCurrencyInfo InlineResponse20010DataCryptoCurrencyInfo `json:"crypto_currency_info,omitempty"`
	// Stablecoin amount

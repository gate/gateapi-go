...
/*
ListMarginAccountBook Query margin account balance change history
Currently only provides transfer history to and from margin accounts. Query time range cannot exceed 30 days
  ...
  - @param "Currency" (optional.String) -  Query history for specified currency. If `currency` is specified, `currency_pair` must also be specified.
  - @param "CurrencyPair" (optional.String) -  Specify margin account currency pair. Used in combination with `currency`. Ignored if `currency` is not specified
...
/*
GetAutoRepayStatus Query user auto repayment settings
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
/*
SetAutoRepay Update user auto repayment settings
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
/*
GetMarginTransferable Get maximum transferable amount for isolated margin
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
/*
SetUserMarketLeverage Set user market leverage multiplier
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
/*
ListMarginUserAccount Query user's isolated margin account list
...
/*
ListCrossMarginLoans Query cross margin borrow history (deprecated)
Sorted by creation time in descending order by default. Set &#x60;reverse&#x3D;false&#x60; for ascending order
  ...
  - @param "Currency" (optional.String) -  Query by specified currency, includes all currencies if not specified
  - @param "Limit" (optional.Int32) -  Maximum number of records returned in a single list

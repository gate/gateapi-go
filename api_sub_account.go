...
ListSubAccounts List sub-accounts
  ...
  - @param "Type_" (optional.String) -  Enter `0` to list all types of sub-accounts (currently supporting cross-margin sub-accounts and regular sub-accounts). Enter `1` to query regular sub-accounts only. If no parameter is passed, only regular sub-accounts will be queried by default.
...
/*
ListSubAccountKeys List all API key pairs of the sub-account
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param userId Sub-account user ID
...
/*
CreateSubAccountKeys Create new sub-account API key pair
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param userId Sub-account user ID
  - @param subAccountKey
...
/*
GetSubAccountKey Get specific API key pair of the sub-account
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param userId Sub-account user ID
...
/*
DeleteSubAccountKeys Delete sub-account API key pair
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param userId Sub-account user ID
  - @param key Sub-account API key
*/
...
/*
LockSubAccount Lock sub-account
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param userId Sub-account user ID
*/
...
/*
UnlockSubAccount Unlock sub-account
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param userId Sub-account user ID
*/

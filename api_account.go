...
/*
GetAccountDetail Retrieve user account information
...
func (a *AccountApiService) GetAccountMainKeys(ctx context.Context) (Key, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/account/main_keys"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
...
/*
ListSTPGroups Query STP user groups created by the user
Only query STP user groups created by the current main account
  ...
  - @param "Name" (optional.String) -  Fuzzy search by name
...
/*
CreateSTPGroup Create STP user group
...
/*
AddSTPGroupUsers Add users to the STP user group
...
/*
DeleteSTPGroupUsers Delete users from the STP user group
...
/*
GetDebitFee Query GT fee deduction configuration
...
/*
SetDebitFee Configure GT fee deduction

...
*/
func (a *SquareApiService) ListSquareAiSearch(ctx context.Context, localVarOptionals *ListSquareAiSearchOpts) (ListSquareAiSearchResponse, *http.Response, error) {
	var (
		...
		localVarReturnValue  ListSquareAiSearchResponse
	)
...
*/
func (a *SquareApiService) ListLiveReplay(ctx context.Context, localVarOptionals *ListLiveReplayOpts) (ListLiveReplayResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  ListLiveReplayResponse
	)

...
/*
GetTransfer Get trading account transfer
Get the current user&#39;s trading account transfer details using the tx_id returned by the transfer endpoint
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param txId Transfer transaction ID

@return AccountTransferDetail
*/
func (a *WalletApiService) GetTransfer(ctx context.Context, txId string) (AccountTransferDetail, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  AccountTransferDetail
	)
	...
	localVarQueryParams.Add("tx_id", parameterToString(txId, ""))
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
/*
GetTransferOrderStatus Main-Sub Account Transfer Status Query
...
/*
GetLowCapExchangeList Retrieve the list of low-liquidity or low-cap tokens
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return []string
*/
func (a *WalletApiService) GetLowCapExchangeList(ctx context.Context) ([]string, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/wallet/getLowCapExchangeList"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
